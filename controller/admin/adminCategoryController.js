...
const editCategory = async (req, res) => {
  try {
    ...
    const updatedCategoryOfferPercent = req.body.updatedCategoryOfferPercent.trim();
    const updatedCategoryOfferExpiry = req.body.updatedCategoryOfferExpiry.trim();
    ...
    existingCategory.offerPercent = updatedCategoryOfferPercent;
    existingCategory.expiryDate = updatedCategoryOfferExpiry;
    // Save the changes
